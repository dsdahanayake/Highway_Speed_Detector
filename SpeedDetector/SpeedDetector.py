...
cap = cv2.VideoCapture("Resources/traffic5.mp4")
...
while True:
    ...
    for box_id in boxes_ids:
        ...
        if(tracker.getsp(id)<tracker.limit()):
            cv2.putText(roi,str(id)+" "+str(tracker.getsp(id)),(x,y-5), cv2.FONT_HERSHEY_PLAIN,1,(255,255,0),2)
            cv2.rectangle(roi, (x, y), (x + w, y + h), (0, 255, 0), 3)
        else:
            cv2.putText(roi,str(id)+ " "+str(tracker.getsp(id)),(x, y-5),cv2.FONT_HERSHEY_PLAIN, 1,(0, 0, 255),2)
    ...
    cv2.line(roi, (0, 265), (460, 265), (0, 0, 255), 2)
    cv2.line(roi, (0, 330), (460, 330), (0, 0, 255), 2)

    cv2.line(roi, (0, 145), (460, 145), (0, 0, 255), 2)
    cv2.line(roi, (0, 170), (460, 170), (0, 0, 255), 2)
